...
def convert_image_to_graph(image, k=16, compactness=50.0):
    try:
        ...
        return (data, label_map, image_name, num_nodes)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        graph_data = convert_image_to_graph(frame_resized, k=current_k, compactness=current_c)
        ...
        cv2.imshow("Labrel map", colored_labelmap)
